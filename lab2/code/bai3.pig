...
-- 1. Load cleaned_data
data = LOAD '/user/nhatanh/cleaned_data' USING PigStorage(';') 
...
-- 7. Store kết quả
STORE max_neg INTO '/user/nhatanh/output/bai3_most_negative_aspect' USING PigStorage(',');
STORE max_pos INTO '/user/nhatanh/output/bai3_most_positive_aspect' USING PigStorage(',');