...
def main():
    ...
    input_path = "/user/nhatanh/lab3/bai1/"
    output_path = "/user/nhatanh/lab3/bai2/output_result"

    # --- BƯỚC 1: Tạo map (MovieID -> List of Genres) ---
    movies_rdd = sc.textFile(input_path + "movies.txt")
    
    # Mẹo: Dùng rsplit(',', 1) để lấy phần tử cuối cùng làm thể loại, tránh lỗi nếu tên phim có dấu phẩy
    # Ví dụ: "1003,Schindler's List,The (1993),Biography|Drama" -> lấy ra "Biography|Drama"
    ...
    # (Tuỳ chọn) Sắp xếp theo điểm trung bình giảm dần cho đẹp
